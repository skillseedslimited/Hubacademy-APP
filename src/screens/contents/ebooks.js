...
import { StyleSheet, Text, View, Image, FlatList,Dimensions, ScrollView, ActivityIndicator, TouchableOpacity } from 'react-native';
  ...
  getVideos = async () => {
    let token = await AsyncStorage.getItem('userToken');
      if (token !== null) {
        ...
        fetch(setup.endPoint+"/content/list?owner_id="+this.props.navigation.state.params.id+"&type_id=4",{
            method: 'get',
            headers: {
